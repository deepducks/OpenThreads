...
function ChannelOverrideRow({
  ...
  return (
    <Card
      size="small"
      style={{ marginBottom: 8, borderLeft: hasOverride ? '3px solid #1677ff' : undefined }}
    >
          ...
          <Col>
            <Space>
              ...
              <Select
                ...
                options={TTL_PRESETS}
                onChange={(v) =>
                  onChange(channel.id, { ...override, tokenTtlSeconds: v })
                }
                style={{ width: 200 }}
              />
            </Space>
...
export default function SettingsPage() {
  ...
  const handleChannelOverride = async (channelId: string, override: ChannelOverride | null) => {
    if (!settings) return;
    ...
    if (override === null) {
      ...
      if (override.tokenTtlSeconds !== undefined) clean.tokenTtlSeconds = override.tokenTtlSeconds;

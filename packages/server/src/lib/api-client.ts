...
// ─── Settings types (mirrored from lib/db to avoid server-only import) ────────
...
// Re-export core types for convenience in client components
export type { Channel, Route, RouteCriteria, Recipient, Thread, Turn };
